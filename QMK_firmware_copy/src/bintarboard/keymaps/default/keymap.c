...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT_60_ansi(
        ...
        // Row 2
        KC_TRNS, KC_1,    KC_2,     KC_3,    KC_4,    KC_5,    KC_TRNS, KC_TRNS, KC_TRNS, KC_UP,   KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS,
        // Row 3
        KC_LSFT, KC_6,    KC_7,     KC_8,    KC_9,    KC_0,    KC_DOT,  KC_TRNS, KC_LEFT, KC_DOWN, KC_RIGHT,KC_TRNS,  KC_TRNS,  KC_TRNS,
        // Row 4
    ...
    // Row 0
        ...
        // Row 4
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_SPC,  KC_TRNS, KC_TRNS, KC_HOME, KC_PGDN, TG(_TTRS),TO(_FN),  KC_TRNS,  KC_TRNS
    )
};